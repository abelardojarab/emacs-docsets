...
(function (globals) {
  ...
  django.catalog = {
    "%(sent_date)s by %(user)s": "op %(sent_date)s door %(user)s", 
    ...
    "Submitted as %(submission_type)s": "Ingediend als %(submission_type)s", 
    "Submitting...": "Indienen...", 
    ...
    "We won't bug you again.": "We zullen u niet meer lastigvallen.", 
